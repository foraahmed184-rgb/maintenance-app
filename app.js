...
function login() {
  ...
  if (role === "worker") {
    ...
    $("pageTitle").textContent = "د ساتنې غوښتنې";
    $("pageSubtitle").textContent = "د کارګر پاڼه";
    $("requestsTitle").textContent = "غوښتنې";
  }
...
function pt(text) {
  ...
  const map = {
    ...
    "شرح العامل بالصوت": "د کارګر غږیز تشریح",
    "فيديو شرح العامل": "د کارګر ویډیو تشریح",
    "قيد التنفيذ": "کار روان دی",
    "تم التنفيذ": "کار بشپړ شو",
    "رفع صور الإنجاز": "د بشپړ کار انځورونه پورته کړئ",
    "بدء تسجيل صوت العامل 🎙️": "د کارګر غږ ثبت پیل کړئ 🎙️",
    "إيقاف التسجيل ⏹️": "ثبت بند کړئ ⏹️",
    "حفظ صوت/فيديو العامل": "د کارګر غږ/ویډیو خوندي کړئ",
    "جديد": "نوی",
    "عادي": "عادي",
    "مهم": "مهم",
    "مستعجل": "بیړنی",
